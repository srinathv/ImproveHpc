...
!  This one us full double precision....looking from ~1 Gflops
...
#if defined(SET_LOOP_COUNT)
  integer, parameter :: LOOP_COUNT = SET_LOOP_COUNT
#else
  integer, parameter :: LOOP_COUNT = 64
#endif
